...
class UpdateSermonesRequest extends FormRequest
{
    ...
    {
        $sermonId = $this->route()->parameter('id');
        
        return [
            'titulo' => 'sometimes|required|string|max:255|min:5',
            'descripcion' => 'sometimes|required|string|min:10|max:1000',
            'url_youtube' => [
                'sometimes',
                'required',
                'url',
                'unique:sermones,url_youtube,' . $sermonId,
